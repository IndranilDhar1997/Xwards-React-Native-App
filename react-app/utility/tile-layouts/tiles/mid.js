...
export default class MidTile extends Tiles {
    ...
    render() {
        return (
            <TouchableOpacity style={{padding: sizeCalculator.convertSize(4), height: sizeCalculator.height(345), width: sizeCalculator.width(426)}} onPress={() => this.onClick()}>
